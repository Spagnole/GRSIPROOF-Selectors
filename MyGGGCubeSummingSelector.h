#ifndef MyGGGCubeSummingSelector_h
#define MyGGGCubeSummingSelector_h
...
////////////////////////////////////////////////////////////////////////////////
/// \class MyGGGCubeSummingSelector
///
...
class MyGGGCubeSummingSelector : public TGRSISelector { //Must be same name as .C and .h
public :
	MyGGGCubeSummingSelector(TTree * /*tree*/ =0) : TGRSISelector(), fGrif(nullptr), fScep(nullptr), fZds(nullptr), fGriffinBgo(nullptr) {
		SetOutputPrefix("g_gg180_cube_"); //Changes prefix of output file
	}
	//These functions are expected to exist
	virtual ~MyGGGCubeSummingSelector() { }
...
private:
	...
	ClassDef(MyGGGCubeSummingSelector,2); //Makes ROOT happier
};

#endif

#ifdef MyGGGCubeSummingSelector_cxx
void MyGGGCubeSummingSelector::InitializeBranches(TTree* tree)
{
	if(!tree) return;
...
#endif // #ifdef MyGGGCubeSummingSelector_cxx
